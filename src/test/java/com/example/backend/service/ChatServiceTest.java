...
class ChatServiceTest {
    ...
    void getSessionById_success() {
        ...
        assertSingleSessionDtoPresent(result, SESSION_ID);
    ...
    void getChatSessionsByUserEmail_success() {
        ...
        assertSingleSessionDto(result, SESSION_ID, USER_EMAIL);
    ...
    private void assertSingleSessionDto(List<ChatSessionDto> result, String expectedSessionId, String expectedEmail) {
        assertThat(result).hasSize(1);
        assertThat(result.get(0).sessionId()).isEqualTo(expectedSessionId);
        assertThat(result.get(0).userEmail()).isEqualTo(expectedEmail);
    }
    
    private void assertSingleSessionDtoPresent(Optional<ChatSessionDto> result, String expectedSessionId) {
        assertThat(result).isPresent();
